Public Class frmMain
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        scrollingFont = New Font("Century Gothic", 17, FontStyle.Regular, GraphicsUnit.Pixel)
        ...
        labelWidthTest.Text = "m"

        Me.Controls.Add(labelWidthTest)

        widestLetter = labelWidthTest.Width + 1
        ...
        pbMatrixPictureBox.Height = (matrixTall + 5) * 5

        pbMatrixPictureBox.Width = widestLetter * 5
        ...
        Dim offScreen As New Bitmap(widestLetter, matrixTall + 5, Imaging.PixelFormat.Format24bppRgb)
        Dim offScreenG As Graphics = Graphics.FromImage(offScreen)

        'offScreenG.TransformPoints(

        pbMatrixPictureBox.BackgroundImageLayout = ImageLayout.Stretch
        pbMatrixPictureBox.BackgroundImage = offScreen
    ...
    Private Sub btnChooseFont_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnChooseFont.Click
        ...
        red = FontDialog1.Color.R
        green = FontDialog1.Color.G
        blue = FontDialog1.Color.B
